...
<html>
    <head>
        ...
        <!-- Custom Theme files -->
        <link href="{{url('lib/css/style.css')}}" rel="stylesheet" type="text/css" media="all" />
        <!-- Custom Theme files -->
        <script src="{{url('lib/js/jquery.min.js')}}"></script>
        <script type="text/javascript" src="{{url('lib/js//jquery.leanModal.min.js')}}"></script>
            ...
            <div class="news-paper">
                <div class="header">
                    ...
                    <div class="header-right">
                        ...
                        <!---pop-up-box---->  
                        <link href="{{url('lib/css/popuo-box.css')}}" rel="stylesheet" type="text/css" media="all"/>
                        <script src="{{url('lib/js/jquery.magnific-popup.js')}}" type="text/javascript"></script>
                        <!---//pop-up-box---->
